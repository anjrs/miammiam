  ...
  methods: {
    async fetchCommandes() {
      try {
        ...
        // Filtrer uniquement les commandes avec le statut "cooking"
        this.commandes = commandesResponse.data.member.filter(commande => commande.status === "cooking");
...
<template>
  <div>
    ...
    <h1>Commandes en cours de préparation</h1>
